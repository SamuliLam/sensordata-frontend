...
export const Sensors = () => {
    ...
    const dsb_link = `/grafana/d/ad727s4/overview?orgId=1&from=now-30d&to=now&timezone=browser&var-metric=$__all&var-sensor=$__all&refresh=10s&theme=light&kiosk&auth_token=${accessToken}`;
    return (
